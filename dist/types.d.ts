...
export declare function makeTypeContentChild({ content, customTypes, required, name, jsDoc }: Omit<TypeContentChild, '__isRoot'>): TypeContentChild;
export declare function makeTypeContentRoot({ joinOperation, name, children, required, jsDoc }: Omit<TypeContentRoot, '__isRoot'>): TypeContentRoot;
/**
 * Holds information for conversion to ts
 */
export declare type TypeContent = TypeContentRoot | TypeContentChild;
